...
//dd($mercaderias);
		return View::make('stockafecha.stockafecha')->with('mercaderias', $mercaderias)->withInput('fecini');
...
//dd($sql);
		...
		$sheet->loadView('stockafecha.stockafechaxc')->with('mercaderias', $mercaderias);
