...
//hay que cambiar por usuario logueado		
    ...
    public function consultamercaderia($cod)
    {
        ...
        $mercaderias = DB::select("SELECT movimientos.documento_id AS Numdoc, movimientos.tipomovimiento_id, tipomovimientos.destipomovimiento, locals.codlocal3, documentos.fechadocumento , documentos.created_at
                        from movimientos
