...
<div class="row">
    <div class="col-md-0 col-md-offset-0">
        <h3>Correcciones - Editar registro de venta (precio de venta)</h3>
...
<form method="POST" id="validadorjs" action="{{url('editaregistro-buscar')}}">
<br>
<div class="row">
    <div class="col-lg-4">
        <div class="input-group">
            <span class="input-group-addon" id="documento_id"># Documento Venta</span>
