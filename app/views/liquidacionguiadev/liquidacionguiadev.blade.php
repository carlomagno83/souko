...
<table class="table table-striped">
    <thead>
        ...
        <tr>
            <td width="20%"><input type="text" name="desprovider[]" id="desprovider[]" value="{{$documento->desprovider}}" class="form-control" tabindex="-1" readonly></td>
            <td width="10%"><input type="text" name="id[]" id="id[]" value="{{$documento->id}}" class="form-control" tabindex="-1" readonly></td>
            <td><input type="text" name="fechadocumento[]" value="{{$documento->fechadocumento}}" readonly class="form-control" tabindex="-1"></td>
            <td width="20%"><input type="text" name="totalcompra[]" value="{{$documento->totalcompra}}" readonly class="form-control" tabindex="-1"></td>
            <td width="15%"><input type="text" name="totalitem[]" value="{{$documento->totalitem}}" readonly class="form-control" tabindex="-1"></td>
