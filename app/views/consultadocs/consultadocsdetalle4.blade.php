...
<h3>Detalle Traslado de Pto a Pto</h3>
...
<div class="alert alert-info" >
    <div class="row">
        ...
        <div class="col-lg-3">
            <div class="input-group">
                <span class="input-group-addon" >Local Inicial</span>
                <input type="text"  value="{{$documento->localini}}" readonly class="form-control" tabindex="-1">
            </div>
        </div>       
        <div class="col-lg-3">
            <div class="input-group">
                <span class="input-group-addon" >Local Final</span>
                <input type="text"  value="{{$documento->localfin}}" readonly class="form-control" tabindex="-1">
            </div>
        </div>       
        <div class="col-lg-3">
            <div class="input-group">
