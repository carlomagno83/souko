...
{{ Form::model($movimiento, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('movimientos.update', $movimiento->id))) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('movimientos.show', 'Cancel', $movimiento->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
