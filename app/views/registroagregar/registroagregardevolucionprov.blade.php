...
<div class="row">
    <div class="col-md-0 col-md-offset-0">
        <h3>Correcciones - Agregar registro Devolución a Proveedor</h3>
...
<form method="POST" id="validadorjs" action="{{url('registroagregardevolucionprov')}}">
<br>
...
<div class="row">
    <div class="col-lg-4">
        <div class="input-group">
            <span class="input-group-addon" id="local">Proveedor</span>
...
<table class="table table-striped">
    <thead>
        ...
        <tr>
            ...
            @if ($localdocumento==substr($mercaderia->codproducto31, 0, 3))
            ...
            @else
            <td width="25%" class="danger"><input type="text" name="mercaderiacodproducto31" value="{{$mercaderia->codproducto31}}" readonly class="form-control" tabindex="-1"></td> 
            <?php $foul=$foul+1; ?>           
            @endif
            @if ($estadomercaderia == 'INA')
