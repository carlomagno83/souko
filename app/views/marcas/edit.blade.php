...
{{ Form::model($marca, array('class' => 'form-horizontal', 'method' => 'PATCH', 'route' => array('marcas.update', $marca->id))) }}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
      ...
      {{ link_to_route('marcas.show', 'Cancelar', $marca->id, array('class' => 'btn btn-lg btn-default')) }}
    </div>
</div>
